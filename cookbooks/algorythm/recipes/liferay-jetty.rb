...
rm -f jdbcRealm.properties jetty-plus.xml jetty-ajp.xml jetty-bio.xml jetty-overlay.xml jetty-xinetd.xml jetty-jmx.xml jetty-annotations.xml jetty-ipaccess.xml jetty-bio-ssl.xml jetty-ssl.xml jetty-spdy.xml jetty-spdy-proxy.xml jetty-proxy.xml jetty-rewrite.xml jetty-testrealm.xml realm.properties README.spnego spnego.conf keystore &&

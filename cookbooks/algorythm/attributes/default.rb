...
default['nexus'] = {
	...
	'system_mail_prefix' => 'system',
	'install_directory' => "#{default['liferay']['install_directory']}/liferay_default/webapps/nexus",
	'jetty_vhost_directory' => "#{default['liferay']['install_directory']}/liferay_default/etc/vhosts",
	'home' => '/var/opt/nexus',
	'ldap' => {
		'user' => 'nexus',
		'password' => 'password'
